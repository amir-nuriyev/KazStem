...
Target: @TARGET@. This thin-arm64 asset requires macOS 15 or newer. It is
unsigned, ad-hoc signed for integrity, and is not Developer ID signed or
notarized; verify the published SHA-256 before handling any Gatekeeper prompt.
